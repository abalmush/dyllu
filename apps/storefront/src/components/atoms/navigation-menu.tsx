...
>(({ className, ...props }, ref) => (
  ...
  >
    <NavigationMenuPrimitive.Viewport
      ref={ref}
      className={cn(
        "origin-top-center text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 relative -mt-4 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-visible bg-transparent md:w-[var(--radix-navigation-menu-viewport-width)]",
        className
      )}
      {...props}
    />
