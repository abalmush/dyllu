    ...
    <section aria-labelledby="product-details-heading">
      ...
      <Accordion type="multiple" defaultValue={["specs"]} className="w-full">
        <AccordionItem value="specs">
          <AccordionTrigger className="text-base font-semibold">
            <span className="flex items-center gap-2">
              <Hammer aria-hidden="true" className="size-5 text-brand-800" />{" "}
              Specificații
            </span>
          </AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="shipping">
          <AccordionTrigger className="text-base font-semibold">
            <span className="flex items-center gap-2">
              <Truck aria-hidden="true" className="size-5 text-brand-800" />{" "}
              Livrare
            </span>
          </AccordionTrigger>
          <AccordionContent>
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              țării. Comenzi peste 1.000 MDL beneficiază de transport gratuit.
        ...
        <AccordionItem value="returns">
          <AccordionTrigger className="text-base font-semibold">
            <span className="flex items-center gap-2">
              <Undo2 aria-hidden="true" className="size-5 text-brand-800" />{" "}
              Retur și garanție
            </span>
          </AccordionTrigger>
          <AccordionContent>
            <p className="text-sm leading-relaxed text-muted-foreground">
              30 de zile pentru retur fără explicații. Toate produsele
              beneficiază de garanția producătorului — minimum 12 luni, până la
              24 luni pentru sculele profesionale. Suport tehnic pentru
              utilizare disponibil L–V, 9:00–18:00.
            </p>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
